...
class MPC(Node):
	...
	def __init__(self):
		...
		self.Qk = np.diag([900, 900, 1000, 100])  # state error cost matrix, for the the next (T) prediction time steps 
		self.Qfk = np.diag([13.5, 13.5, 1000, 100])  # final state error matrix, penalty  for the final state constraints
