...
diffdrive = np.loadtxt('/home/chris/sim_ws/src/benchmark_tests/benchmark_tests/Results/Localisation/Accuracy/aut_diffdrive.csv', delimiter=',')
mit = np.loadtxt('/home/chris/sim_ws/src/benchmark_tests/benchmark_tests/Results/Localisation/Accuracy/aut_mit.csv', delimiter=',')
