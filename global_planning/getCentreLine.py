...
class TrackContour:
    def __init__(self, points, n_pts=None, smoothing_s=0.5):
        print(points.shape)
...
if __name__ == '__main__':
    # itterate through all png files in the maps folder and extract the centre line
    for file in os.listdir('maps/'):
        if file.endswith('.png'):
            map_name = file.split('.')[0]
            print(f"Extracting centre line for: {map_name}")
            extract_centre_line(map_name)
