...
class Track:
	...
	def __init__(self, map_name):
		...
		plt.figure( num=f'{map_name}_racelines')
		...
		plt.plot(shortMinCurveX, shortMinCurveY, label='Minimum Curvature Path based on Shortest Path')
		...
		plt.plot(minCurveS, minCurve[:, 5], label='Minimum Curvature Path')
		plt.plot(shortMinCurveS, shortMinCurve[:, 5], label='Minimum Curvature Path based on Shortest Path')
		plt.legend(loc='upper right')
		...
		plt.plot(minCurveS, minCurve[:, 4], label='Minimum Curvature Path')
		plt.plot(shortMinCurveS, shortMinCurve[:, 4], label='Minimum Curvature Path based on Shortest Path')
		plt.legend(loc='upper right')
